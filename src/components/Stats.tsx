    ...
    <section className="relative overflow-hidden bg-gradient-to-r from-primary-100 via-primary-200 to-accent-200">
      ...
      <Reveal className="mx-auto hidden max-w-7xl grid-cols-5 gap-5 px-6 py-6 sm:grid lg:px-10">
        <div className="flex flex-col items-center justify-center gap-2 rounded-xl border border-white/70 bg-white/80 p-5 text-center shadow-sm backdrop-blur-sm">
          <div className="flex items-center gap-2 rounded-md bg-gradient-to-r from-primary-600 to-accent-600 px-3 py-1.5">
            ...
            <Counter to={4.8} decimals={1} className="text-sm font-bold text-white" />
          </div>
        ...
        {statItems.map((stat) => (
          ...
          >
            ...
            <p className="mt-1 text-[11px] font-medium text-zinc-700">{stat.sub}</p>
          </div>
        ))}
      ...
      <Reveal className="px-6 py-6 sm:hidden">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          ...
          <div className="rounded-xl border border-white/70 bg-white/80 p-4 text-center shadow-sm backdrop-blur-sm">
            <p className="text-lg font-extrabold text-primary-700">24/7</p>
            <p className="mt-1 text-[11px] font-medium text-zinc-700">Support Available</p>
          </div>
        </div>
      </Reveal>
