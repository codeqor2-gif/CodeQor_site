      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
          ...
          <Reveal delay={0.15}>
            <Link
              href="/services"
              className="inline-flex shrink-0 items-center gap-2 rounded-md bg-gradient-to-r from-primary-600 to-accent-600 px-6 py-3 text-sm font-semibold text-white shadow-[0_8px_24px_rgba(0,102,204,0.4)] transition-all duration-300 hover:brightness-110 cursor-pointer"
            >
              View All Services
            </Link>
          </Reveal>
