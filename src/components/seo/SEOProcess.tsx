...
const steps = [
  { number: "01", title: "SEO Audit", subtitle: "Comprehensive Analysis" },
  { number: "02", title: "Keyword Research", subtitle: "Strategic Targeting" },
  { number: "03", title: "On-Page Optimization", subtitle: "Content & Technical" },
  { number: "04", title: "Link Building", subtitle: "Authority Growth" },
  { number: "05", title: "Monitor & Report", subtitle: "Track Rankings & ROI" },
];
...
const iconPaths = [
  ...
  "M13.828 10.172a4 4 0 010 5.656l-3 3a4 4 0 01-5.656-5.656l1.5-1.5m8.156-8.156l1.5-1.5a4 4 0 015.656 5.656l-3 3a4 4 0 01-5.656 0M10 14L14 10",
    ...
    <section ref={sectionRef} className="py-6 lg:py-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <Reveal className="mb-6">
          <SectionHeading title="Our SEO" highlight="Process" />
        </Reveal>
