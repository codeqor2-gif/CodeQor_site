          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <Reveal x={-40}>
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-[1.75rem] border border-slate-200 shadow-[0_20px_60px_rgba(0,102,204,0.14)]">
                  <Image src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1200&auto=format&fit=crop" alt="Cloud migration services" width={800} height={600} className="aspect-[4/3] h-auto w-full object-cover" />
            ...
            <Reveal x={40}>
              <div className="max-w-xl">
                ...
                <p className="mt-5 text-base leading-7 text-slate-600">Move applications and data with minimal disruption while maintaining security, integrity, and business continuity.</p>
