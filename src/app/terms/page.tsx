        ...
        <div className="mt-12 space-y-10">
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-zinc-600">
              By accessing and using the services provided by NetRoots Technologies ("Company",
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-zinc-600">
              NetRoots Technologies provides IT services, software development, digital marketing,
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-zinc-600">
              ...
              are the property of NetRoots Technologies or its licensors. You may not reproduce,
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-zinc-600">
              In no event shall NetRoots Technologies be liable for any indirect, incidental,
